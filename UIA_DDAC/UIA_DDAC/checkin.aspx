<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="checkin.aspx.cs" Inherits="UIA_DDAC.checkin" %>
...
<body>
                    ...
                    <div class="col-md-8 col-sm-6 col-xs-2">
                        <div class="main-menu">
                            <ul class="visible-lg visible-md">
                                ...
                                <li class="active"><a href="checkin.aspx">Online Check-In</a></li>
    ...
    <div class="contact-page">
        <div class="container">
            <div class="row">
               <center> <h1 style="font-weight:bold; font-size:larger;">Online Check-In</h1><br />
                <form id="modify" runat="server">
                    <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" Width="650px" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
                    ...
                    <br />
                    <p>
                        <asp:Button ID="cin" runat="server" Text="Check-In" OnClick="cin_Click" class="main-btn" />
                    </p>
                </form></center>
            </div>
        </div>
