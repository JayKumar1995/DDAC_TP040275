<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="manageprofile.aspx.cs" Inherits="UIA_DDAC.manageprofile" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 col-sm-6 col-xs-2">
                            <div class="main-menu">
                                ...
                                <li class="active"><a href="manageprofile.aspx">Manage Profile</a></li>
                    ...
                    <div class="col-md-5 col-sm-6">
                        ...
                        <div class="contact-form">
                            <form name="contactform" id="contactform"   runat="server">
                                <p>
                                    <asp:TextBox ID="id" runat="server" placeholder="ID" ReadOnly="true"></asp:TextBox>
                                </p>
                                <p>
                                    <asp:TextBox ID="username" runat="server" placeholder="Username" ReadOnly="true"></asp:TextBox> 
                                </p>
                                <p>
                                    <asp:TextBox ID="password" runat="server" placeholder="Password"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*" ControlToValidate="password" ForeColor="Red"></asp:RequiredFieldValidator>
                                </p>
                                <p>
                                    <asp:TextBox ID="email" runat="server" placeholder="Em@il"></asp:TextBox><asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="*" ControlToValidate="email" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" ForeColor="Red"></asp:RegularExpressionValidator>
                                </p>
                                <asp:Button ID="btnUpdate" runat="server" Text="Update" class="mainBtn" OnClick="btnUpdate_Click"/>
                                <p><asp:Label ID="lblNotification" runat="server" ForeColor="Green"/></p>
                            </form>
                        </div> <!-- /.contact-form -->
                    </div>
                </div>
